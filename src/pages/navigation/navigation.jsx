...
const navigation = [
  ...
  { name: "Single", href: "/single", current: false },
];
  ...
  return (
    <>
      <div className="flex justify-between mx-auto max-w-7xl">
        <div className="">
          <p className="p-2">Can we help you?</p>
        </div>
      ...
      <div className="min-h-full shadow-sm border-y">
                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      ...
                      <Menu as="div" className="relative ml-3">
                        <div>
                          <Menu.Button className="relative flex max-w-xs items-center text-md font-medium  p-2">
