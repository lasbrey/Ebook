...
const filters = [
  ...
  },
  {
    ...
    name: "Author",
    options: [
      { value: "john-doe", label: "John Doe", checked: false },
      { value: "jane-smith", label: "Jane Smith", checked: false },
      { value: "michael-johnson", label: "Michael Johnson", checked: false },
      { value: "emily-williams", label: "Emily Williams", checked: false },
      { value: "david-brown", label: "David Brown", checked: false },
      { value: "sarah-miller", label: "Sarah Miller", checked: false },
    ],
  },
  {
    id: "price",
  ...
  },
  {
    ...
    options: [
      ...
      { value: "2-star", label: "2 Stars", checked: false },
      { value: "3-star", label: "3 Stars", checked: false },
      { value: "4-star", label: "4 Stars", checked: false },
      { value: "5-star", label: "5 Stars", checked: false },
    ],
  },
];
                ...
                <form className="hidden lg:block">
                  {filters.map((section) => (
                    <Disclosure
                      as="div"
                      key={section.id}
                      className="border border-gray-200 py-6"
                    >
                      {({ open }) => (
                        <>
                          <h3 className="-my-3 flow-root">
                            <Disclosure.Button className="flex w-full items-center justify-between bg-white p-3 text-md font-semibold hover:text-gray-500">
                              <span className="font-medium text-gray-900">
                                {section.name}
                              </span>
                              <span className="ml-6 flex items-center">
